/**
 * Removes opaque black background from clinic-logo-edit-2.png via edge flood-fill.
 * Run: node scripts/process-clinic-logo-matte.mjs
 */
...
const inputPath = join(root, "public/brand/clinic-logo-edit-2.png");
